...
grails.plugin.springsecurity.interceptUrlMap = [
	...
	[pattern: '/ubicacion/**',   	access: ['ROLE_ADMIN']],
	...
	[pattern: '/producto/**',   	access: ['ROLE_ADMIN']],
	[pattern: '/precio/**',   	 	access: ['ROLE_ADMIN']],
	[pattern: '/presentacion/**',   access: ['ROLE_ADMIN']],
	[pattern: '/categoria/**',   	access: ['ROLE_ADMIN']],
	[pattern: '/unidadMedida/**',   access: ['ROLE_ADMIN']],
